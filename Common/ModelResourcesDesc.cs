...
{	
	...
	public class ModelResourcesDesc
	{
		...
		{			
			typeIdsInInsertOrder.Add(ModelCode.PERLNGTPHSIMPD);
			typeIdsInInsertOrder.Add(ModelCode.PERLNGTSEQIMPD);			
			typeIdsInInsertOrder.Add(ModelCode.PHASEIMPDTA);
			typeIdsInInsertOrder.Add(ModelCode.SERIESCMPNSTR);
			typeIdsInInsertOrder.Add(ModelCode.DCLINESGMNT);
			typeIdsInInsertOrder.Add(ModelCode.ACLINESGMNT);			
		...
		{			
			...
			notSettablePropertyIds.Add(ModelCode.PERLENIMP_ACLINSGMNTS);
			notSettablePropertyIds.Add(ModelCode.PERLNGTPHSIMPD_PHSIMPDDATAS);
